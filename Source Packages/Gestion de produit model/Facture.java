...
public class Facture {
  ...
  // public String etat;
    ...
    public Facture(int N_fact,String nom_prenom_cl, float montant_a_paye, float montant_verser, float montant_reste, String date_versement) {
       this.N_fact = N_fact;
        this.nom_prenom_cl = nom_prenom_cl;
    ...
    public String getnom_prenom_cl() {
        return nom_prenom_cl;
    }
