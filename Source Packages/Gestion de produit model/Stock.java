...
public class Stock {
   ...
   String designation;
    ...
    public Stock(int N_prod, String designation, String categorie,int qte_totale, int qte_vente,  float prix_vent, float prix_unt) {
        this.N_prod = N_prod;
        this.designation = designation;
        this.categorie = categorie;
      //  this.unite = unite; //     this.date_exp = date_exp;
    ...
    public Stock(int i, String string, String string0, int i0, float parseFloat, float parseFloat0, String text) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
     public Stock(int N_prod, String designation, String categorie, int qte_vente) {
        this.N_prod = N_prod;
        this.designation = designation;
        this.categorie = categorie;
        this.qte_vente = qte_vente;
    }
       public Stock(float gain) {
       this.gain = gain;
    }
